...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RatingServiceException> handleRatingServiceException(ResourceNotFoundException ex) {

        RatingServiceException error = new RatingServiceException(
                404,
    ...
    public ResponseEntity<RatingServiceException> handleUnknownException(Exception ex) {
