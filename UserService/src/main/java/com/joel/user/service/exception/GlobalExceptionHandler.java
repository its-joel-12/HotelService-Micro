...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<UserServiceException> handleException(ResourceNotFoundException ex) {
        UserServiceException error = new UserServiceException(
                404,
    ...
    public ResponseEntity<UserServiceException> handleUnknownException(Exception ex) {
        UserServiceException error = new UserServiceException(
                500,
